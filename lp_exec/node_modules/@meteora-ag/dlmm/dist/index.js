...
var MAX_BIN_ARRAY_SIZE = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _2 => _2.find, 'call', _3 => _3(([_, v]) => v.name == "MAX_BIN_PER_ARRAY"), 'optionalAccess', _4 => _4[1], 'access', _5 => _5.value]), () => ( 0))
);
var DEFAULT_BIN_PER_POSITION = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _6 => _6.find, 'call', _7 => _7(([_, v]) => v.name == "DEFAULT_BIN_PER_POSITION"), 'optionalAccess', _8 => _8[1], 'access', _9 => _9.value]), () => ( 0))
);
var BIN_ARRAY_BITMAP_SIZE = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _10 => _10.find, 'call', _11 => _11(([_, v]) => v.name == "BIN_ARRAY_BITMAP_SIZE"), 'optionalAccess', _12 => _12[1], 'access', _13 => _13.value]), () => ( 0))
);
var EXTENSION_BINARRAY_BITMAP_SIZE = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _14 => _14.find, 'call', _15 => _15(([_, v]) => v.name == "EXTENSION_BINARRAY_BITMAP_SIZE"), 'optionalAccess', _16 => _16[1], 'access', _17 => _17.value]), () => ( 0))
);
var POSITION_MAX_LENGTH = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _18 => _18.find, 'call', _19 => _19(([_, v]) => v.name == "POSITION_MAX_LENGTH"), 'optionalAccess', _20 => _20[1], 'access', _21 => _21.value]), () => ( 0))
);
...
var PRECISION = new (0, _decimaljs2.default)("18446744073709551616");
  ...
  function fromBin(bin, binId, binStep, baseTokenDecimal, quoteTokenDecimal, version, lbPair) {
    ...
    if (supportLimitOrder) {
      ...
      return {
        ...
        fulfilledOrderAmountX: new (0, _anchor.BN)(0),
        fulfilledOrderAmountY: new (0, _anchor.BN)(0),
        limitOrderFeeAskSide: new (0, _anchor.BN)(0),
        limitOrderFeeBidSide: new (0, _anchor.BN)(0),
        openOrderAmount: new (0, _anchor.BN)(0),
        totalProcessingOrderAmount: new (0, _anchor.BN)(0),
        processedOrderRemainingAmount: new (0, _anchor.BN)(0),
        orderAge: 0,
...
function getExcludedFeeAmount(includedFeeAmount, tradeFeeNumerator) {
  const tradingFee = includedFeeAmount.mul(tradeFeeNumerator).add(FEE_PRECISION.sub(new (0, _anchor.BN)(1))).div(FEE_PRECISION);
...
function getIncludedFeeAmount(excludedFeeAmount, tradeFeeNumerator) {
  ...
  const includedFeeAmount = excludedFeeAmount.mul(FEE_PRECISION).add(denominator.sub(new (0, _anchor.BN)(1))).div(denominator);
...
function splitFee(tradingFee, protocolShare, mmAmountIn, totalAmountIn) {
  ...
  const mmFee = tradingFee.mul(mmAmountIn).add(totalAmountIn.sub(new (0, _anchor.BN)(1))).div(totalAmountIn);
  const totalLoFee = tradingFee.sub(mmFee);
  const loFee = totalLoFee.mul(LIMIT_ORDER_FEE_SHARE).div(new (0, _anchor.BN)(BASIS_POINT_MAX));
  const loProtocolFee = totalLoFee.sub(loFee);
  const mmProtocolFee = mmFee.mul(protocolShare).div(new (0, _anchor.BN)(BASIS_POINT_MAX));
  ...
  switch (functionType) {
    ...
    case 0 /* Undetermined */:
      return lbPairState.rewardInfos.every(
        (rewardInfo) => rewardInfo.mint.equals(_web3js.PublicKey.default)
      );
    default:
...
function getExcludedFeeAmountIn(bin, includedFeeOutAmount, swapForY) {
  ...
  let exactOutAmount = _bnjs2.default.min(remainingOutAmount, mmAmount);
  ...
  if (remainingOutAmount.gt(new (0, _bnjs2.default)(0))) {
    exactOutAmount = _bnjs2.default.min(remainingOutAmount, processedOrderRemainingAmount);
    amountIn = getAmountIn(exactOutAmount, bin.price, swapForY, 0 /* Up */);
    remainingOutAmount = remainingOutAmount.sub(exactOutAmount);
    totalAmountIn = totalAmountIn.add(amountIn);
    if (remainingOutAmount.gt(new (0, _bnjs2.default)(0))) {
      exactOutAmount = _bnjs2.default.min(remainingOutAmount, openOrderAmount);
      amountIn = getAmountIn(exactOutAmount, bin.price, swapForY, 0 /* Up */);
      totalAmountIn = totalAmountIn.add(amountIn);
    }
  }
...
function swapExactOutQuoteAtBin(bin, binStep, sParameter, vParameter, outAmount, swapForY, supportLimitOrder, feeOnInput) {
  ...
  if (includedFeeAmountOut.gte(maxAmountOut)) {
    ...
    if (delta.gt(new (0, _bnjs2.default)(1))) {
...
function getLimitOrderAmountsBySwapDirection(bin, swapForY) {
  ...
  return {
    openOrderAmount: new (0, _bnjs2.default)(0),
    processedOrderRemainingAmount: new (0, _bnjs2.default)(0)
  };
}
function getExactInFillAmountResult(bin, amountIn, swapForY, supportLimitOrder) {
  ...
  let processedOrderAmountIn = new (0, _bnjs2.default)(0);
  let processedOrderAmountOut = new (0, _bnjs2.default)(0);
  let openOrderAmountIn = new (0, _bnjs2.default)(0);
  let openOrderAmountOut = new (0, _bnjs2.default)(0);
...
function swapExactInQuoteAtBin(bin, binStep, sParameter, vParameter, inAmount, swapForY, supportLimitOrder, feeOnInput) {
  let tradingFee = new (0, _bnjs2.default)(0);
  ...
  const { fee, protocolFee } = splitFee(
    tradingFee,
    new (0, _bnjs2.default)(sParameter.protocolShare),
...
function getLimitOrderLiquidity(bin, supportLimitOrder) {
  if (!supportLimitOrder) {
    return {
      orderAmountX: new (0, _bnjs2.default)(0),
      orderAmountY: new (0, _bnjs2.default)(0)
    };
  }
...
function wrapOracle(oracleAddress, data, binStep, currentActiveBinId, baseTokenDecimals, quoteTokenDecimals, program) {
  ...
  for (let i = 0; i < oracleState.length.toNumber(); i++) {
    ...
    const cumulativeActiveBinId = new (0, _bnjs2.default)(
      cumulativeActiveBinIdSlice,
      "le"
    ).fromTwos(128);
    offset += 16;
    const createdAtSlice = observationSlice.subarray(offset, offset + 8);
    const createdAt = new (0, _bnjs2.default)(createdAtSlice, "le");
    offset += 8;
    const lastUpdatedAtSlice = observationSlice.subarray(offset, offset + 8);
    const lastUpdatedAt = new (0, _bnjs2.default)(lastUpdatedAtSlice, "le");
    observations.push(
...
var DynamicOracle = class {
  ...
  getActiveIdByTime(timePoint0, timePoint1) {
    const t0 = _bnjs2.default.min(timePoint0, timePoint1);
    const t1 = _bnjs2.default.max(timePoint0, timePoint1);
  ...
  getUiPriceByTime(timePoint0, timePoint1) {
    ...
    const uiMultiplier = new (0, _decimaljs2.default)(10).pow(
...
var limitOrderFilter = () => {
  return {
    memcmp: {
      bytes: _bytes.bs58.encode(Buffer.from(getAccountDiscriminator("limitOrder"))),
      offset: 0
    }
  };
};
...
var LimitOrderV1Wrapper = class {
  ...
  getBinArrayIndexesCoverage() {
    ...
    for (const bin of this.limitOrderBinData) {
      const binArrayIndex = binIdToBinArrayIndex(new (0, _bnjs2.default)(bin.binId()));
      binArrayIndexes.add(binArrayIndex.toNumber());
    }
    return [...binArrayIndexes].map((index) => new (0, _bnjs2.default)(index));
  }
  getBinArrayKeysCoverage(programId) {
    return this.getBinArrayIndexesCoverage().map(
      (index) => deriveBinArray(this.lbPair(), index, programId)[0]
  ...
  parseInfo(programId, lbPair, baseMint, quoteMint, clock, binArrayMap) {
    let totalAmountXDeposited = new (0, _bnjs2.default)(0);
    let totalAmountYDeposited = new (0, _bnjs2.default)(0);
    let totalFilledAmountX = new (0, _bnjs2.default)(0);
    let totalFilledAmountY = new (0, _bnjs2.default)(0);
    let totalUnfilledAmountX = new (0, _bnjs2.default)(0);
    let totalUnfilledAmountY = new (0, _bnjs2.default)(0);
    let totalSwappedAmountX = new (0, _bnjs2.default)(0);
    let totalSwappedAmountY = new (0, _bnjs2.default)(0);
    let totalFeeAmountX = new (0, _bnjs2.default)(0);
    let totalFeeAmountY = new (0, _bnjs2.default)(0);
    const collectFeeMode = lbPair.parameters.collectFeeMode;
    const parsedLimitOrderBinData = [];
    const tokenXUiMultiplier = new (0, _decimaljs2.default)(10).pow(
      new (0, _decimaljs2.default)(baseMint.decimals)
    );
    const tokenYUiMultiplier = new (0, _decimaljs2.default)(10).pow(
      new (0, _decimaljs2.default)(quoteMint.decimals)
    );
    for (const loBin of this.limitOrderBinData) {
      const binArrayIndex = binIdToBinArrayIndex(new (0, _bnjs2.default)(loBin.binId()));
      ...
      let depositAmountX = new (0, _bnjs2.default)(0);
      let depositAmountY = new (0, _bnjs2.default)(0);
      let swappedAmountX = new (0, _bnjs2.default)(0);
      let swappedAmountY = new (0, _bnjs2.default)(0);
      let filledAmountX = new (0, _bnjs2.default)(0);
      let filledAmountY = new (0, _bnjs2.default)(0);
      let unFilledAmountX = new (0, _bnjs2.default)(0);
      let unFilledAmountY = new (0, _bnjs2.default)(0);
      let feeAmountX = new (0, _bnjs2.default)(0);
      let feeAmountY = new (0, _bnjs2.default)(0);
      if (loBin.isAsk()) {
      ...
      parsedLimitOrderBinData.push({
        binId: loBin.binId(),
        empty: loBin.isEmpty(),
        depositAmountX: new (0, _decimaljs2.default)(depositAmountX.toString()).div(tokenXUiMultiplier).toString(),
        depositAmountY: new (0, _decimaljs2.default)(depositAmountY.toString()).div(tokenYUiMultiplier).toString(),
        unfilledAmountX: new (0, _decimaljs2.default)(unFilledAmountX.toString()).div(tokenXUiMultiplier).toString(),
        unfilledAmountY: new (0, _decimaljs2.default)(unFilledAmountY.toString()).div(tokenYUiMultiplier).toString(),
        swappedAmountX: new (0, _decimaljs2.default)(swappedAmountX.toString()).div(tokenXUiMultiplier).toString(),
        swappedAmountY: new (0, _decimaljs2.default)(swappedAmountY.toString()).div(tokenYUiMultiplier).toString(),
        isAskSide: loBin.isAsk(),
        filledAmountX: new (0, _decimaljs2.default)(filledAmountX.toString()).div(tokenXUiMultiplier).toString(),
        filledAmountY: new (0, _decimaljs2.default)(filledAmountY.toString()).div(tokenYUiMultiplier).toString(),
        feeAmountX: new (0, _decimaljs2.default)(feeAmountX.toString()).div(tokenXUiMultiplier).toString(),
        feeAmountY: new (0, _decimaljs2.default)(feeAmountY.toString()).div(tokenYUiMultiplier).toString(),
    ...
    return {
      totalDepositAmountX: new (0, _decimaljs2.default)(totalAmountXDeposited.toString()).div(tokenXUiMultiplier).toString(),
      totalDepositAmountY: new (0, _decimaljs2.default)(totalAmountYDeposited.toString()).div(tokenYUiMultiplier).toString(),
      limitOrderBinData: parsedLimitOrderBinData,
      totalUnfilledAmountX: new (0, _decimaljs2.default)(totalUnfilledAmountX.toString()).div(tokenXUiMultiplier).toString(),
      totalUnfilledAmountY: new (0, _decimaljs2.default)(totalUnfilledAmountY.toString()).div(tokenYUiMultiplier).toString(),
      totalFilledAmountX: new (0, _decimaljs2.default)(totalFilledAmountX.toString()).div(tokenXUiMultiplier).toString(),
      totalFilledAmountY: new (0, _decimaljs2.default)(totalFilledAmountY.toString()).div(tokenYUiMultiplier).toString(),
      totalSwappedAmountX: new (0, _decimaljs2.default)(totalSwappedAmountX.toString()).div(tokenXUiMultiplier).toString(),
      totalSwappedAmountY: new (0, _decimaljs2.default)(totalSwappedAmountY.toString()).div(tokenYUiMultiplier).toString(),
      totalFeeAmountX: new (0, _decimaljs2.default)(totalFeeAmountX.toString()).div(tokenXUiMultiplier).toString(),
      totalFeeAmountY: new (0, _decimaljs2.default)(totalFeeAmountY.toString()).div(tokenYUiMultiplier).toString(),
      transferFeeExcludedWithdrawableAmountX: new (0, _decimaljs2.default)(
        transferFeeExcludedWithdrawableAmountX.toString()
      ).div(tokenXUiMultiplier).toString(),
      transferFeeExcludedWithdrawableAmountY: new (0, _decimaljs2.default)(
...
function getUpdatedLimitOrderAmount(limitOrderStatus, limitOrderData, bin, collectFeeMode) {
  let fulFilledAmount = new (0, _bnjs2.default)(0);
  let unFilledAmount = new (0, _bnjs2.default)(0);
  switch (limitOrderStatus) {
    case 0 /* NotFilled */:
      unFilledAmount = limitOrderData.amount();
      break;
    case 1 /* PartialFilled */:
      unFilledAmount = limitOrderData.amount().mul(bin.processedOrderRemainingAmount).add(bin.totalProcessingOrderAmount.sub(new (0, _bnjs2.default)(1))).div(bin.totalProcessingOrderAmount);
...
function calculateLimitOrderFee(fulfilledAmount, isAskSide, collectFeeMode, bin) {
  if (fulfilledAmount.isZero() || bin.fulfilledOrderAmountX.isZero() && isAskSide || bin.fulfilledOrderAmountY.isZero() && !isAskSide) {
    return {
      feeX: new (0, _bnjs2.default)(0),
      feeY: new (0, _bnjs2.default)(0)
    };
  }
  let limitOrderFee = new (0, _bnjs2.default)(0);
  if (isAskSide) {
...
var DLMM = class {
  ...
  static async getPairPubkeyIfExists(connection, tokenX, tokenY, binStep, baseFactor, baseFeePowerFactor, concreteFunctionType, collectFeeMode, opt) {
    ...
    presetParametersWithIndex = presetParametersWithIndex.filter((p) => {
      return p.account.concreteFunctionType == (_nullishCoalesce(concreteFunctionType, () => ( 1)) /* LiquidityMining */) && p.account.collectFeeMode == (_nullishCoalesce(collectFeeMode, () => ( 0)) /* InputOnly */);
    });
  ...
  async getLimitOrderByUserAndLbPair(userPubKey) {
    ...
    const lbPairAndBinArrays = await chunkedGetMultipleAccountInfos(
      this.program.provider.connection,
      [this.pubkey, _web3js.SYSVAR_CLOCK_PUBKEY, ...binArrayPubkeyArrays]
    );
  ...
  async quoteCreateLimitOrder({
    ...
    return {
      limitOrderCost: limitOrderCost / _web3js.LAMPORTS_PER_SOL,
  ...
  async addLiquidityByWeight2({
    ...
    for (const { lowerBinId: lowerBinId2, upperBinId: upperBinId2 } of chunkedBinRange) {
      const binArrayAccountsMeta = getBinArrayAccountMetasCoverage(
        new (0, _anchor.BN)(lowerBinId2),
        new (0, _anchor.BN)(upperBinId2),
        this.pubkey,
        this.program.programId
      );
      const lowerBinArrayIndex = binIdToBinArrayIndex(new (0, _anchor.BN)(lowerBinId2));
      const upperBinArrayIndex = binIdToBinArrayIndex(new (0, _anchor.BN)(upperBinId2));
      ...
      let totalChunkedXAmount = new (0, _anchor.BN)(0);
      let totalChunkedYAmount = new (0, _anchor.BN)(0);
      let totalYValue = new (0, _anchor.BN)(0);
      for (let i = 0; i < chunkedXYAmountDistribution.length; i++) {
        const distribution = chunkedXYAmountDistribution[i];
        const yAmount = totalYAmount.mul(distribution.yAmountBpsOfTotal).div(new (0, _anchor.BN)(BASIS_POINT_MAX));
        const xAmount = totalXAmount.mul(distribution.xAmountBpsOfTotal).div(new (0, _anchor.BN)(BASIS_POINT_MAX));
        const binPrice = getQPriceFromId(
          new (0, _anchor.BN)(distribution.binId),
          new (0, _anchor.BN)(this.lbPair.binStep)
        );
        const yValueOfX = totalXAmount.mul(distribution.xAmountBpsOfTotal).mul(binPrice).shrn(SCALE_OFFSET).div(new (0, _anchor.BN)(BASIS_POINT_MAX));
      ...
      const chunkedBinLiquidityDistribution = chunkedQuoteDistribution.map(
        ({ binId, yValue }) => {
          const weight = yValue.mul(new (0, _anchor.BN)(65535)).div(totalYValue);
          return {
            binId,
  ...
  async placeLimitOrder({
    ...
    const userTokenAddress = _spltoken.getAssociatedTokenAddressSync.call(void 0, 
      tokenMint,
      owner,
      true,
      tokenProgram
