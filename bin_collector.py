...
def round_once(now):
    ...
    open_pos_pools = []
    for sf in ("hfna_paper_state.json", "hfna_paper_w7_state.json", "hfna_paper_repo_state.json", "hfna_paper_flow_state.json", "hfna_paper_reflow_state.json", "hfna_paper_thin_state.json"):
        try:
